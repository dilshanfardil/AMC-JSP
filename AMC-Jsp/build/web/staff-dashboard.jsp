        ...
        <div class="row">
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-primary o-hidden h-100">
              ...
              <a class="card-footer text-white clearfix small z-1" href="staff-customer-manage.jsp">
                <span class="float-left">Manage AMC customers.</span>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-warning o-hidden h-100">
              ...
              <a class="card-footer text-white clearfix small z-1" href="staff-appointment-manage.jsp">
                <span class="float-left">Manage Customer Appointments</span>
                <span class="float-right">
                  <i class="fas fa-angle-right"></i>
                </span>
              </a>
