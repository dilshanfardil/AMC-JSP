...
public class AppointmentDao {
	...
	public boolean addAppointment(Appointment appointment) {
		...
		try {
			...
			String sql = "INSERT INTO appointments(app_id, cus_id, doc_id, app_date) VALUES (?,?,?,?)";
	...
	public boolean updateAppointment(Appointment appointment) {
		...
		try {
			...
			connection = DbUtil.getConnection();
				...
				String sql = "UPDATE appointments SET cus_id=?, doc_id =?, app_date=?, medicine=?, feedback=?, comment=?, charge=?, is_paid=? WHERE app_id=?";
